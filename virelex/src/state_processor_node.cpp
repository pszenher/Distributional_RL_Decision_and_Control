...
private:
    void synchronizeCallback(const nav_msgs::msg::Odometry::SharedPtr odometry_msg, const virelex_msgs::msg::PointCloudCluster::SharedPtr lidar_msg) {
    ...
    void computeClusterVelocities(const nav_msgs::msg::Odometry::SharedPtr odometry_msg,
                                  const virelex_msgs::msg::PointCloudCluster::SharedPtr lidar_msg,
    ...
    std::shared_ptr<message_filters::Subscriber<virelex_msgs::msg::PointCloudCluster>> lidar_subscriber_;
    std::shared_ptr<message_filters::TimeSynchronizer<nav_msgs::msg::Odometry, virelex_msgs::msg::PointCloudCluster>> time_sync_;
    // rclcpp::Publisher<std_msgs::msg::String>::SharedPtr timestamp_publisher_;
    rclcpp::Publisher<virelex_msgs::msg::State>::SharedPtr state_publisher_;
    
    bool print_latency;
    nav_msgs::msg::Odometry::SharedPtr last_odometry_msg;
    virelex_msgs::msg::PointCloudCluster::SharedPtr last_lidar_msg;
